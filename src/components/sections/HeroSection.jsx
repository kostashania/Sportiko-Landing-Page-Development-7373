...
const HeroSection = () => {
  ...
  useEffect(() => {
    console.log('HeroSection: Loading settings...');
    loadSettings();
  }, [loadSettings]);

  // Update hero data from settings whenever settings change
  useEffect(() => {
    console.log('HeroSection: Settings changed:', settings);
    
    if (settings?.content) {
      const content = settings.content;
      console.log('HeroSection: Updating hero data from content settings:', content);
    ...
    if (settings?.general) {
      console.log('HeroSection: Updating logo from general settings:', settings.general);
      setHeroData(prev => ({
        ...prev,
  ...
  const handleLogoError = (e) => {
    console.log('HeroSection: Logo failed to load, using fallback');
    e.target.src = fallbackLogo;
  };

  console.log('HeroSection: Current hero data:', heroData);
