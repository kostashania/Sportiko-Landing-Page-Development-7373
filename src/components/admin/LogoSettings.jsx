...
const LogoSettings = () => {
  ...
  const handleLogoUpload = async (event) => {
    ...
    try {
      ...
      console.log('Logo URL to save:', url);
      setLogoUrl(url);
  ...
  const handleSave = async () => {
    ...
    try {
      console.log('Saving logo settings:', { logoUrl, logoAlt });
  ...
  return (
    <div className="space-y-8">
      ...
      {success && (
        <div className={`border rounded-lg p-4 ${success.includes('Σφάλμα') || success.includes('σφάλμα') ? 'bg-red-50 border-red-200' : 'bg-green-50 border-green-200'}`}>
          <div className="flex items-center gap-2">
            <SafeIcon 
              icon={success.includes('Σφάλμα') ? FiAlertCircle : FiImage} 
              className={`w-5 h-5 ${success.includes('Σφάλμα') || success.includes('σφάλμα') ? 'text-red-600' : 'text-green-600'}`} 
            />
            ...
            <div className="bg-gray-50 p-8 rounded-lg w-full flex items-center justify-center min-h-32">
              {imageError ? (
                <div className="flex flex-col items-center justify-center p-8 text-gray-500">
                  ...
                  <img src={fallbackLogo} alt="Fallback Logo" className="max-h-20 max-w-full object-contain mt-4" />
                </div>
              ) : (
                <img 
                  src={logoUrl} 
          ...
          <div className="bg-white p-4 rounded-lg">
            ...
            <div className="border rounded p-2 bg-gray-50 flex items-center gap-2">
              {imageError ? (
                ...
                <img src={logoUrl} alt={logoAlt} className="h-8" onError={handleImageError} />
              )}
          ...
          <div className="bg-white p-4 rounded-lg">
            ...
            <div className="border rounded p-4 bg-blue-600 text-center">
              {imageError ? (
                ...
                <img src={logoUrl} alt={logoAlt} className="h-12 mx-auto mb-2" onError={handleImageError} />
              )}
          ...
          <div className="bg-white p-4 rounded-lg">
            ...
            <div className="border rounded p-2 bg-gray-800 text-center">
              {imageError ? (
                ...
                <img src={logoUrl} alt={logoAlt} className="h-6 mx-auto" onError={handleImageError} />
              )}
